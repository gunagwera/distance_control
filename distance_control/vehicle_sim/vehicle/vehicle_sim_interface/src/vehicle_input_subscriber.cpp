...
class VehicleInputSubscriber
{
  private:
    ...
    void twistStampedCallback2(const geometry_msgs::TwistStamped::ConstPtr &input_twist_msg);
    void twistCallback2(const geometry_msgs::Twist::ConstPtr &input_twist_msg);
...
VehicleInputSubscriber::VehicleInputSubscriber() : nh_(""), pnh_("~")
{
    ...
    // twiststamped_sub_ = nh_.subscribe("vehicle3/twist_cmd", 1, &VehicleInputSubscriber::twistStampedCallback2, this); | if needed
    // twist_sub_ = nh_.subscribe("vehicle3/cmd_vel", 1, &VehicleInputSubscriber::twistCallback2, this); | if needed
...
// independent callbacks for @autonomity 
// func desc:
// v2's velocity and position to be defined as functions of v1

void VehicleInputSubscriber::twistStampedCallback2(const geometry_msgs::TwistStamped::ConstPtr &input_twist_msg)
{
    std_msgs::Float64 output_wheel_right_rear, output_wheel_left_rear, output_steering_right_front, output_steering_left_front;
    output_wheel_right_rear.data = input_twist_msg->twist.linear.x / wheel_radius_;
    output_wheel_left_rear.data = input_twist_msg->twist.linear.x / wheel_radius_;
...
void VehicleInputSubscriber::twistCallback2(const geometry_msgs::Twist::ConstPtr &input_twist_msg)
{
    std_msgs::Float64 output_wheel_right_rear, output_wheel_left_rear, output_steering_right_front, output_steering_left_front;
    output_wheel_right_rear.data = input_twist_msg->linear.x / wheel_radius_;
    output_wheel_left_rear.data = input_twist_msg->linear.x / wheel_radius_;
...
// end my naive attempt callbacks
